      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-slate-500 dark:text-slate-400 mt-1">Manage school announcements</p>
          </div>
          <button
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-slate-200 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100"
                  required
                />
              </div>
              <div>
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="rounded"
                />
                <label htmlFor="pinned" className="text-sm text-slate-700 dark:text-slate-300">Pin this announcement</label>
              </div>
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-4 py-2 border border-slate-200 dark:border-slate-600 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200"
                >
                  Cancel
                </button>
              </div>
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className={`px-2 py-0.5 text-xs font-medium rounded ${
                        announcement.category === 'curriculum' ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300' : 'bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300'
                      }`}>
