...
export default function DiscussionsPage() {
  ...
  const { user } = useAuth()
  const dashboardHref = `/${user?.role || 'student'}/dashboard`
    ...
    <DashboardLayout>
      <div className="page-container max-w-3xl">
        <div className="mb-6">
          <Link
            href={dashboardHref}
            className="inline-flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-widest text-slate-400 hover:text-brand-500 transition-colors mb-4 group"
          >
