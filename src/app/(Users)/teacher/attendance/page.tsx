      ...
      <div className="p-4 md:p-8 bg-slate-50 dark:bg-slate-900 min-h-screen transition-colors">
        <div className="mb-8">
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1">
            Review and mark attendance for {rooms.length} active rooms with {totalStudents} total students.
          </p>
        </div>
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between px-1">
            <h2 className="text-xl font-bold text-slate-800 dark:text-white">Select a Room</h2>
